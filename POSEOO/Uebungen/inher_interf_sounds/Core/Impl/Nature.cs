...
public class Nature : SoundCategory, ISoundEmitter
{
    public Nature(string name, string low, string high, string highest, string loudness, string spectrum) : base(name)
    {
        Low = low;
        High = high;
        Highest = highest;

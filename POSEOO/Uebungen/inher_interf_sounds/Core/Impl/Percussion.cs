...
public class Percussion : SoundCategory, ISoundEmitter
{
    public Percussion(string name, string low, string high, string highest, string loudness, string spectrum) : base(name)
    {
        Low = low;
        High = high;
        Highest = highest;
